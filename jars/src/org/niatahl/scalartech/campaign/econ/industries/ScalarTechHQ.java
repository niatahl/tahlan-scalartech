package org.niatahl.scalartech.campaign.econ.industries;
...
public class ScalarTechHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	
	@Override
	public boolean isHidden() {
		return !market.getFactionId().equals("scalartech");
	}
	
	@Override
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals("scalartech");
	}
